...
default['dynatrace']['memory_analysis_server']['linux']['installer']['file_url'] = 'http://files.dynatrace.com/downloads/OnPrem/dynaTrace/7.1/7.1.0.1803/dynatrace-analysisserver-7.1.0.1803-linux-x86.jar'
